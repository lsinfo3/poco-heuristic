...
%
%   Copyright 2012-2015 David Hock, Stefan Geißler, Fabian Helmschrott,
%                       Steffen Gebert, Stanislav Lange
...
addpath('images');
addpath('planetlab');
addpath('code/hierarchical');
addpath('code/dynamic');
addpath('code/heuristics')
topology=[];
topology_org=[];
coordinates=[];
tm=[];
...
limDim4=[];
paretoValuesFirst=[];
limits.maxLatencyN2C=[];
limits.controllerImbalance=[];
limits.maxLatencyC2C=[];
limits.avgLatencyN2C=[];
limits.avgLatencyC2C=[];
limits.maxLatencyN2CAllNodeFailures=[];
limits.controllerImbalanceAllNodeFailures=[];
limits.maxLatencyC2CAllNodeFailures=[];
limits.maxNumberOfControllerlessNodes=[];
limits.avgLatencyN2CAllNodeFailures=[];
limits.avgLatencyC2CAllNodeFailures=[];
limits.maxLatencyN2CAllControllerFailures=[];
limits.controllerImbalanceAllControllerFailures=[];
limits.maxLatencyC2CAllControllerFailures=[];
limits.maxNumberOfControllerlessNodes=[];
limits.avgLatencyN2CAllControllerFailures=[];
limits.avgLatencyC2CAllControllerFailures=[];

mValuesF={'<html><font size="2">Max node to controller latency (failure free)</font></html>', 'maxLatencyN2C',['Max node to controller latency',10,'(failure free)'],'Max node to controller latency (failure free)';...
    '<html><font size="2">Controller imbalance (failure free)</font></html>', 'controllerImbalance','Controller imbalance (failure free)','Controller imbalance (failure free)';...
    '<html><font size="2">Max controller to controller latency (failure free)</font></html>', 'maxLatencyC2C',['Max controller to controller',10,'latency (failure free)'],'Max controller to controller latency (failure free)';...
    '<html><font size="2">Average node to controller latency (failure free)</font></html>', 'avgLatencyN2C',['Average node to controller latency',10,'(failure free)'],'Average node to controller latency (failure free)';...
    '<html><font size="2">Average controller to controller latency (failure free)</font></html>', 'avgLatencyC2C',['Average controller to controller',10,'latency (failure free)'],'Average controller to controller latency (failure free)';...
    };

mValuesDyn={'<html><font size="2">Max node to PGW latency (failure free)</font></html>', 'maxLatencyN2C',['Max node to PGW latency',10,'(failure free)'],'Max node to PGW latency (failure free)';...
    '<html><font size="2">PGW imbalance (failure free)</font></html>', 'controllerImbalance','PGW imbalance (failure free)','PGW imbalance (failure free)';...
    '<html><font size="2">Average node to PGW latency (failure free)</font></html>', 'avgLatencyN2C',['Average node to PGW latency',10,'(failure free)'],'Average node to PGW latency (failure free)';...
    };

mValuesDim34F={'<html></html>','','','';...
    '<html><font size="2">Max node to controller latency (failure free)</font></html>', 'maxLatencyN2C',['Max node to controller latency',10,'(failure free)'],'Max node to controller latency (failure free)';...
    '<html><font size="2">Controller imbalance (failure free)</font></html>', 'controllerImbalance','Controller imbalance (failure free)','Controller imbalance (failure free)';...
    '<html><font size="2">Max controller to controller latency (failure free)</font></html>', 'maxLatencyC2C',['Max controller to controller',10,'latency (failure free)'],'Max controller to controller latency (failure free)';...
    '<html><font size="2">Average node to controller latency (failure free)</font></html>', 'avgLatencyN2C',['Average node to controller latency',10,'(failure free)'],'Average node to controller latency (failure free)';...
    '<html><font size="2">Average controller to controller latency (failure free)</font></html>', 'avgLatencyC2C',['Average controller to controller',10,'latency (failure free)'],'Average controller to controller latency (failure free)';...
...
mValuesN={'<html><font size="2">Max node to controller latency (failure free)</font></html>', 'maxLatencyN2C',['Max node to controller latency',10,'(failure free)'],'Max node to controller latency (failure free)';...
    '<html><font size="2">Controller imbalance (failure free)</font></html>', 'controllerImbalance','Controller imbalance (failure free)','Controller imbalance (failure free)';...
    '<html><font size="2">Max controller to controller latency (failure free)</font></html>', 'maxLatencyC2C',['Max controller to controller',10,'latency (failure free)'],'Max controller to controller latency (failure free)';...
    '<html><font size="2">Average node to controller latency (failure free)</font></html>', 'avgLatencyN2C',['Average node to controller latency',10,'(failure free)'],'Average node to controller latency (failure free)';...
    '<html><font size="2">Average controller to controller latency (failure free)</font></html>', 'avgLatencyC2C',['Average controller to controller',10,'latency (failure free)'],'Average controller to controller latency (failure free)';...
    '<html><font size="2">Max node to controller latency (up to two node failures)</font></html>', 'maxLatencyN2CAllNodeFailures',['Max node to controller latency',10,'(up to two node failures)'],'Max node to controller latency (up to two node failures)';...
    '<html><font size="2">Controller imbalance (up to two node failures)</font></html>', 'controllerImbalanceAllNodeFailures',['Controller imbalance',10,'(up to two node failures)'],'Controller imbalance (up to two node failures)';...
    '<html><font size="2">Max controller to controller latency (up to two node failures)</font></html>', 'maxLatencyC2CAllNodeFailures',['Max controller to controller',10,'latency (up to two node failures)'],'Max controller to controller latency (up to two node failures)';...
    '<html><font size="2">Controller-less nodes (up to two node failures)</font></html>', 'maxNumberOfControllerlessNodes',['Controller-less nodes',10,'(up to two node failures)'],'Controller-less nodes (up to two node failures)';...
    '<html><font size="2">Average node to controller latency (up to two node failures)</font></html>', 'avgLatencyN2CAllNodeFailures',['Average node to controller latency',10,'(up to two node failures)'],'Average node to controller latency (up to two node failures)';...
    '<html><font size="2">Average controller to controller latency (up to two node failures)</font></html>', 'avgLatencyC2CAllNodeFailures',['Average controller to controller',10,'latency (up to two node failures)'],'Average controller to controller latency (up to two node failures)';...
    };

mValuesDim34N={'<html></html>','','','';...
    '<html><font size="2">Max node to controller latency (failure free)</font></html>', 'maxLatencyN2C',['Max node to controller latency',10,'(failure free)'],'Max node to controller latency (failure free)';...
    '<html><font size="2">Controller imbalance (failure free)</font></html>', 'controllerImbalance','Controller imbalance (failure free)','Controller imbalance (failure free)';...
    '<html><font size="2">Max controller to controller latency (failure free)</font></html>', 'maxLatencyC2C',['Max controller to controller',10,'latency (failure free)'],'Max controller to controller latency (failure free)';...
    '<html><font size="2">Average node to controller latency (failure free)</font></html>', 'avgLatencyN2C',['Average node to controller latency',10,'(failure free)'],'Average node to controller latency (failure free)';...
...
mValuesC={'<html><font size="2">Max node to controller latency (failure free)</font></html>', 'maxLatencyN2C',['Max node to controller latency',10,'(failure free)'],'Max node to controller latency (failure free)';...
    '<html><font size="2">Controller imbalance (failure free)</font></html>', 'controllerImbalance','Controller imbalance (failure free)','Controller imbalance (failure free)';...
    '<html><font size="2">Max controller to controller latency (failure free)</font></html>', 'maxLatencyC2C',['Max controller to controller',10,'latency (failure free)'],'Max controller to controller latency (failure free)';...
    '<html><font size="2">Average node to controller latency (failure free)</font></html>', 'avgLatencyN2C',['Average node to controller latency',10,'(failure free)'],'Average node to controller latency (failure free)';...
    '<html><font size="2">Average controller to controller latency (failure free)</font></html>', 'avgLatencyC2C',['Average controller to controller',10,'latency (failure free)'],'Average controller to controller latency (failure free)';...
    '<html><font size="2">Max node to controller latency (up to k-1 controller failures)</font></html>', 'maxLatencyN2CAllControllerFailures',['Max node to controller latency',10,'(up to k-1 controller failures)'],'Max node to controller latency (up to k-1 controller failures)';...
    '<html><font size="2">Max controller imbalance (up to k-1 controller failures)</font></html>', 'controllerImbalanceAllControllerFailures',['Max controller imbalance',10,'(up to k-1 controller failures)'],'Max controller imbalance (up to k-1 controller failures)';...
    '<html><font size="2">Max controller to controller latency (up to k-1 controller failures)</font></html>', 'maxLatencyC2CAllControllerFailures',['Max controller to controller latency',10,'(up to k-1 controller failures)'],'Max controller to controller latency (up to k-1 controller failures)';...
    '<html><font size="2">Controller-less nodes (up to k-1 controller failures)</font></html>', 'maxNumberOfControllerlessNodes',['Controller-less nodes ',10,'(up to k-1 controller failures)'],'Controller-less nodes (up to k-1 controller failures)';...
    '<html><font size="2">Average node to controller latency (up to k-1 controller failures)</font></html>', 'avgLatencyN2CAllControllerFailures',['Average node to controller latency',10,'(up to k-1 controller failures)'],'Average node to controller latency (up to k-1 controller failures)';...
    '<html><font size="2">Average controller to controller latency (up to k-1 controller failures)</font></html>', 'avgLatencyC2CAllControllerFailures',['Average controller to controller latency',10,'(up to k-1 controller failures)'],'Average controller to controller latency (up to k-1 controller failures)';...
    };

mValuesDim34C={'<html></html>','','','';...
    '<html><font size="2">Max node to controller latency (failure free)</font></html>', 'maxLatencyN2C',['Max node to controller latency',10,'(failure free)'],'Max node to controller latency (failure free)';...
    '<html><font size="2">Controller imbalance (failure free)</font></html>', 'controllerImbalance','Controller imbalance (failure free)','Controller imbalance (failure free)';...
    '<html><font size="2">Max controller to controller latency (failure free)</font></html>', 'maxLatencyC2C',['Max controller to controller',10,'latency (failure free)'],'Max controller to controller latency (failure free)';...
    '<html><font size="2">Average node to controller latency (failure free)</font></html>', 'avgLatencyN2C',['Average node to controller latency',10,'(failure free)'],'Average node to controller latency (failure free)';...
...
hFileMenu = uimenu('Parent',hMainFigure,'HandleVisibility','on','Label','File');
    ...
    hImportMenu = uimenu('Parent',hFileMenu,'Label','Import','HandleVisibility','on','Separator','on','Enable','off');
        hImportNodeWeightsMenuitem = uimenu('Parent',hImportMenu,'Label','Node weights','HandleVisibility','on','Callback',@importNodeWeights);
...
% Heuristical Menu
hHeuristicMenu = uimenu('Parent',hMainFigure,'Label','Heuristics','HandleVisibility','on','Visible','on','Enable','off');
    hPSAMenuitem = uimenu('Parent',hHeuristicMenu,'Label','Pareto Simulated Annealing','HandleVisibility','on','Visible','on','Callback',@initPSACallback);
    hPCKMMenuitem = uimenu('Parent',hHeuristicMenu,'Label','Pareto Capacitated k-Medoids','HandleVisibility','on','Visible','on','Callback',@initPCKMCallback);


% Dynamic menu
hDynamicMenu = uimenu('Parent',hMainFigure,'Label','Dynamic','HandleVisibility','on','Visible','off');

    
% Help menu
hHelpMenu = uimenu('Parent',hMainFigure,'HandleVisibility','on','Label','Help');
    hOnlinHelpMenu = uimenu('Parent',hHelpMenu,'Label','Open online help','HandleVisibility','on','Callback', @openOnlineHelpCallback);
    hAboutMenu = uimenu('Parent',hHelpMenu,'Label','About','HandleVisibility','on','Callback', @openAboutCallback);


% hPlotAxes1 Controls
hLabelControllerIDs = uicontrol('Parent',hMainFigure,'Units','normalized','HorizontalAlignment','left','Position',[0.78 0.91 0.17 0.02],'String','Controller IDs','Style','text','BackgroundColor',get(hMainFigure,'Color'),'Visible','off','FontWeight','bold');
hLabelControllerFailureIDs = uicontrol('Parent',hMainFigure,'Units','normalized','HorizontalAlignment','left','Position',[0.78 0.85 0.17 0.02],'String','Controller failure IDs','Style','text','BackgroundColor',get(hMainFigure,'Color'),'Visible','off','FontWeight','bold');
hLabelNodeFailureIDs = uicontrol('Parent',hMainFigure,'Units','normalized','HorizontalAlignment','left','Position',[0.78 0.79 0.17 0.02],'String','Node failure IDs','Style','text','BackgroundColor',get(hMainFigure,'Color'),'Visible','off','FontWeight','bold');
hEditControllerIDs = uicontrol('Parent',hMainFigure,'Units','normalized','HorizontalAlignment','left','Position',[0.78 0.88 0.14 0.03],'Style','edit','BackgroundColor','w','HandleVisibility','on','Visible','off','Callback',@inputMainFigureCallback);
hEditControllerFailureIDs = uicontrol('Parent',hMainFigure,'Units','normalized','HorizontalAlignment','left','Position',[0.78 0.82 0.14 0.03],'Style','edit','BackgroundColor','w','HandleVisibility','on','Visible','off','Callback',@inputMainFigureCallback);
hEditNodeFailureIDs = uicontrol('Parent',hMainFigure,'Units','normalized','HorizontalAlignment','left','Position',[0.78 0.76 0.14 0.03],'Style','edit','BackgroundColor','w','HandleVisibility','on','Visible','off','Callback',@inputMainFigureCallback);

hLabelPlotOptions = uicontrol('Parent',hMainFigure,'Units','normalized','HorizontalAlignment','left','Position',[0.78 0.69 0.1 0.05],'String','Show:','Style','text','BackgroundColor',get(hMainFigure,'Color'),'Visible','off','FontWeight','bold');
...
hDim3Label = uicontrol('Parent',hMainFigure,'Units','normalized','HorizontalAlignment','left','Position',[0.78 0.22 0.17 0.04],...
    'String','Value of Dimension 3','Style','text','BackgroundColor',get(hMainFigure,'Color'),'Visible','off','FontWeight','bold');
hDim3PopupMenu = uicontrol('Parent', hMainFigure,'Units','normalized','Position',[0.78 0.20 0.17 0.04],'HandleVisibility','on','String','','Style','popupmenu','Callback',@hAxisPopupMenuCallback,'Visible','off','BackgroundColor',get(hMainFigure,'Color'),'FontUnits','normalized','FontSize',0.63);

hDim4Label = uicontrol('Parent',hMainFigure,'Units','normalized','HorizontalAlignment','left','Position',[0.78 0.14 0.17 0.04],...
    'String','Value of Dimension 4','Style','text','BackgroundColor',get(hMainFigure,'Color'),'Visible','off','FontWeight','bold');
hDim4PopupMenu = uicontrol('Parent', hMainFigure,'Units','normalized','Position',[0.78 0.12 0.17 0.04],'HandleVisibility','on','String','','Style','popupmenu','Callback',@hAxisPopupMenuCallback,'Visible','off','BackgroundColor',get(hMainFigure,'Color'),'FontUnits','normalized','FontSize',0.63);

hParetoLimitButton = uicontrol('Parent',hMainFigure,'Units','normalized','Position',[0.78 0.06 0.17 0.04],'HandleVisibility','on','String','Edit Pareto Range','Style','pushbutton','Callback',@hParetoLimitButtonCallback,'Visible','off');
...
plotTimerDynamic=timer('TimerFcn',@plotFiguresDynamicCallback, 'StartDelay', 0.5);
...
% Controls for dynamic topologies

hPrevSubButton= uicontrol('Parent',hMainFigure,'Style','pushbutton','Units','normalized','Position',[buttonLeft 0.1 0.1 0.06],'FontUnits','normalized','FontSize',0.38,'String','<html><span style="font-size:35px">&#xffe9;</span><sup>Previous</sup></html>','Callback',{@plotDynamicTopologyCallback,-1},'Visible','off','Enable','off');
hNextSubButton= uicontrol('Parent',hMainFigure,'Style','pushbutton','Units','normalized','Position',[0.89 0.1 0.1 0.06],'FontUnits','normalized','FontSize',0.38,'String','<html><sup>Next</sup><span style="font-size:35px">&#xffeb;</span></html>','Callback',{@plotDynamicTopologyCallback,0},'Visible','off','Enable','off');
hToggleDynamicViewButton = uicontrol('Parent',hMainFigure,'Style','pushbutton','Units','normalized','Position',[buttonLeft 0.9 buttonWidth 0.06],'FontUnits','normalized','FontSize',0.38,'String','Show pareto plot','Callback',@toggleDynamicViewCallback,'Visible','off','Enable','off');
hXAxisDynamicLabel = uicontrol('Parent',hMainFigure,'Units','normalized','HorizontalAlignment','left','Position',[0.07 0.08 0.14 0.02],...
    'String','Value on x-axis','Style','text','BackgroundColor',get(hMainFigure,'Color'),'Visible','off','FontWeight','bold');
hXAxisPopupMenuDynamic = uicontrol('Parent', hMainFigure,'Units','normalized','Position',[0.07 0.06 0.3 0.02],'HandleVisibility','on','String','','Style','popupmenu','Callback',@hAxisPopupMenuDynamicCallback,'Visible','off','BackgroundColor',get(hMainFigure,'Color'));
hYAxisDynamicLabel = uicontrol('Parent',hMainFigure,'Units','normalized','HorizontalAlignment','left','Position',[0.45 0.08 0.14 0.02],...
    'String','Value on y-axis','Style','text','BackgroundColor',get(hMainFigure,'Color'),'Visible','off','FontWeight','bold');
hYAxisPopupMenuDynamic = uicontrol('Parent', hMainFigure,'Units','normalized','Position',[0.45 0.06 0.3 0.02],'HandleVisibility','on','String','','Style','popupmenu','Callback',@hAxisPopupMenuDynamicCallback,'Visible','off','BackgroundColor',get(hMainFigure,'Color'));
hDynamicControllerLabel = uicontrol('Parent',hMainFigure,'Units','normalized','HorizontalAlignment','left','Position',[0.78 0.78 0.17 0.02],'String','Number of PGWs','Style','text','BackgroundColor',get(hMainFigure,'Color'),'Visible','off','FontWeight','bold');
hDynamicControllerInput = uicontrol('Parent',hMainFigure,'Units','normalized','HorizontalAlignment','left','Position',[0.78 0.74 0.14 0.03],'Style','edit','BackgroundColor','w','HandleVisibility','on','Visible','off','Callback',@dynamicInputCallback);
hDynamicLatencyLabel = uicontrol('Parent',hMainFigure,'Units','normalized','HorizontalAlignment','left','Position',[0.78 0.70 buttonWidth 0.02],'String','Maximum node to PGW distance','Style','text','BackgroundColor',get(hMainFigure,'Color'),'Visible','off','FontWeight','bold');
hDynamicLatencyInput = uicontrol('Parent',hMainFigure,'Units','normalized','HorizontalAlignment','left','Position',[0.78 0.66 0.14 0.03],'Style','edit','BackgroundColor','w','HandleVisibility','on','Visible','off','Callback',@dynamicInputCallback);
...
% Loads a topology
     function OpenTopologyCallback(hObject, eventdata)
        [filename, pathname] = uigetfile({'*.topo.mat;*.graphml;*.xml;*.dyn.mat','Graph topology (*.topo.mat, *.graphml, *.xml)';'*.topo.mat','POCO topology (*.topo.mat)';'*.graphml','GraphML / GephiGraphML topology (*.graphml)';'*.xml','SNDlib topology (*.xml)'},'Please select a valid topology file');
        ...
        if ~isequal(filename, 0)
            ...
            elseif ~isempty(strfind(filename,'.dyn.mat'))
                [coordinates, topology, citynodes, sgwnodesstatic, neplusnodes, neplusnodesNOSGW, baseX, baseY, corenodes, distanceMatrix,dynamic,isDynamic]=loadDynamic(file);
                if isDynamic
                    initDynamic;
                end
                return;
...
% y-axis
    function hAxisPopupMenuCallback(hObject, eventdata)
        ...
        valueDim3=char(mValuesDim34{get(hDim3PopupMenu,'Value'),2});
        valueDim4=char(mValuesDim34{get(hDim4PopupMenu,'Value'),2});
        plotAxes2;
    ...
    function optimizeFailureFree(hObject,eventdata,k)
        if ~isempty(topology)
            ...
            if panelAxis1Pos(4) < 0.8
                ...
                set(hDim3PopupMenu,'Visible','on');
                set(hDim4PopupMenu,'Visible','on');
                set(hDim3Label,'Visible','on');
                set(hDim4Label,'Visible','on');
            end
            valuex=char(mValues{1,2});
            valuey=char(mValues{2,2});
            valueDim3 = char(mValuesDim34{1,2});
            valueDim4 = char(mValuesDim34{1,2});
            
            set(hXAxisPopupMenu,'Value',1);
            set(hYAxisPopupMenu,'Value',2);
            set(hDim3PopupMenu,'Value',1);
            set(hDim4PopupMenu,'Value',1);
...
% up to two node failures
    function optimizeNodeFailure(hObject,eventdata,k)
        if ~isempty(topology)
            ...
            valueDim3 = char(mValues{1,2});
            valueDim4 = char(mValues{1,2});
            set(hDim3PopupMenu,'Value',1);
            set(hDim4PopupMenu,'Value',1);
    ...
    function plotted=plotAxes1(colorscheme)
        ...
        if isempty(topology)
            ...
            if exist('colorscheme','var')                
                ...
                elseif isPCKM
                    plotTopologyPCKM(topology,coordinates,controllerplaces,assignments,currPlacement,'Parent',hPlotAxes1,'nodeWeights',weights,'ShowIds',showIds,'ShowNodeToControllerLatency',showNodeToControllerLatency,'ShowControllerToControllerLatency',showControllerToControllerLatency,'ShowControllerlessHeatmap',showControllerlessHeatmap,'ShowControllerImbalance',showControllerImbalance,'ShowNodeWeights',showNodeWeights,'Markers', 'o','Position',position,'DistanceMatrix',distanceMatrix);
                else
...
% pareto-optimal values.
    function plotAxes2
        if ~isempty(solution) && ~isempty(valuex)
            ...
            set(hParetoLimitButton,'Visible','on');
            axes(hPlotAxes2);
            cla
            myidx=floor(currPlacement);
            if ~plcTopo
                
                if (get(hDim3PopupMenu,'Value')==1 && get(hDim4PopupMenu,'Value')==1)
                	[paretoidx textXaxis textYaxis]=plotPareto2D(solution.(valuex),solution.(valuey),'ShowSelectedidx',myidx,'Parent',hPlotAxes2,'XLim',limits.(valuex),'YLim',limits.(valuey));
                    if isempty(paretoValuesFirst)
                        paretoValuesFirst=paretoidx;
                    end
                elseif ((get(hDim3PopupMenu,'Value')~=1 && get(hDim4PopupMenu,'Value')==1) || (get(hDim3PopupMenu,'Value') == get(hDim4PopupMenu,'Value')))
                    textXaxis='';
                    textYaxis='';
                    [paretoidx]=plotPareto(solution.(valuex),solution.(valuey),'ShowSelectedidx',myidx,'Parent',hPlotAxes2,'Dim3in',solution.(valueDim3),'Dim3Label',char(mValuesDim34(get(hDim3PopupMenu,'Value'),4)),'Dim4in',solution.(valueDim3),'Dim4Label',char(mValuesDim34(get(hDim3PopupMenu,'Value'),4)),'XLim',limits.(valuex),'YLim',limits.(valuey),'Dim3Lim',limits.(valueDim3),'Dim4Lim',limits.(valueDim3));
                elseif (get(hDim3PopupMenu,'Value')==1 && get(hDim4PopupMenu,'Value')~=1)
                    textXaxis='';
                    textYaxis='';
                    [paretoidx]=plotPareto(solution.(valuex),solution.(valuey),'ShowSelectedidx',myidx,'Parent',hPlotAxes2,'Dim3in',solution.(valueDim4),'Dim3Label',char(mValuesDim34(get(hDim4PopupMenu,'Value'),4)),'Dim4in',solution.(valueDim4),'Dim4Label',char(mValuesDim34(get(hDim4PopupMenu,'Value'),4)),'XLim',limits.(valuex),'YLim',limits.(valuey),'Dim3Lim',limits.(valueDim4),'Dim4Lim',limits.(valueDim4));
                else
                    textXaxis='';
                    textYaxis='';
%                    [paretoidx]=plotPareto(solution.(valuex),solution.(valuey),'ShowSelectedidx',myidx,'Parent',hPlotAxes2,'Dim3in',solution.(valueDim3),'Dim3Label',char(mValuesDim34(get(hDim3PopupMenu,'Value'),4)),'Dim4in',solution.(valueDim4),'Dim4Label',char(mValuesDim34(get(hDim4PopupMenu,'Value'),4)));
                    [paretoidx]=plotPareto(solution.(valuex),solution.(valuey),'ShowSelectedidx',myidx,'Parent',hPlotAxes2,'Dim3in',solution.(valueDim3),'Dim3Label',char(mValuesDim34(get(hDim3PopupMenu,'Value'),4)),'Dim4in',solution.(valueDim4),'Dim4Label',char(mValuesDim34(get(hDim4PopupMenu,'Value'),4)),'XLim',limits.(valuex),'YLim',limits.(valuey),'Dim3Lim',limits.(valueDim3),'Dim4Lim',limits.(valueDim4));
                end
            else
            ...
            controllerplaces=str2num(get(hEditControllerIDs,'String'));
            if ~isempty(controllerplaces) && (length(controllerplaces)~=size(nk,2) || min(sort(controllerplaces)==sort(nk(myidx,:)))==0)
                if ~tmbool % tm not activated
                    tmtemp=ones(1,size(topology,1));
                else
                    tmtemp=tm(tmindex,:);
...
%        mValues2={};
        ...
        sizeDynTopo=[];
        currSubgraph=1;
        if ~isempty(get(hDynamicMenu,'Children'))
            delete (get(hDynamicMenu,'Children'));
        end
        ...
        fullView;
        set(hDynamicMenu,'Visible','off');
        set(hToggleDynamicViewButton,'Visible','off');
        set(hPrevSubButton,'Visible','off');
        set(hNextSubButton,'Visible','off');
        ...
        set(hDim3PopupMenu,'Visible','off');
        set(hDim3Label,'Visible','off');
        set(hDim4PopupMenu,'Visible','off');
        set(hDim4Label,'Visible','off');
        ...
        set(hEditControllerFailureIDs,'String','');
        set(hEditNodeFailureIDs,'String','');
        set(hXAxisDynamicLabel,'Visible','off');
        set(hYAxisDynamicLabel,'Visible','off');
        set(hXAxisPopupMenuDynamic,'Visible','off');
        set(hYAxisPopupMenuDynamic,'Visible','off');
        set(hDynamicControllerInput,'Visible','off');
        set(hDynamicControllerLabel,'Visible','off');
        set(hDynamicLatencyInput,'Visible','off');
        set(hDynamicLatencyLabel,'Visible','off');
        
        set(hPlotOptionsMenu,'Enable','off');
        set(hPredefinedViewsMenu,'Enable','off');
        set(hHeuristicMenu,'Enable','off');
        ...
        set(hSavePlacementsMenuitem,'Enable','off');
        set(hParetoLimitButton,'Visible','off');
    end
        ...
        switch myaxes
            ...
            case hPlotAxes2
                if isDynamic
                    ...
                    txt=sprintf('Result selected with:\n%s:%.2f\n%s:%.2f\n%d results\nDisplaying in 5 seconds.',mValues{get(hXAxisPopupMenuDynamic,'Value'),2},pos(1),mValues{get(hYAxisPopupMenuDynamic,'Value'),2},pos(2),length(idxhit));
                    currPlacement = idxhit(1);
                    controllerplaces=nk(idxhit(1),:);
%                    set(hEditControllerIDs,'String',num2str(nk(idxhit(1),:)));
 %                   checkScenarioSelection;
                    start(plotTimerDynamic);
                elseif isHierarchic
...
% Opens a figure containing information about POCO
    function openAboutCallback(hObject, eventdata)
        openAbout
    end
    ...
    function openAbout
        ...
        text = strcat('<html><center><img src="',imgsrc,'" border="0"><br><br><font family="verdana"><span style="font-size:20pt;">POCO: A framework for Pareto-Optimal Resilient Controller Placement</span><br><br>&copy; 2012-2015<br><br>David Hock, Stefan Gei&szlig;ler, Fabian Helmschrott, Steffen Gebert, Stanislav Lange<br><br>Chair of Communication Networks, University of W&uuml;rzburg, Germany<br><br>http://www3.informatik.uni-wuerzburg.de/poco<br>https://github.com/lsinfo3/poco</center></html>');
...
% Changes the theme of the GUI
    ...
    function changeTheme(backgroundColor, foregroundColor)
        if strcmp(get(hThemesClassicMenuitem,'Checked'),'off')
            ...
            set(hDim3PopupMenu,'ForegroundColor',foregroundColor,'BackgroundColor',backgroundColor);
            set(hDim4PopupMenu,'ForegroundColor',foregroundColor,'BackgroundColor',backgroundColor);
            set(hDynamicControllerInput,'ForegroundColor',foregroundColor,'BackgroundColor',backgroundColor);
            set(hDynamicLatencyInput,'ForegroundColor',foregroundColor,'BackgroundColor',backgroundColor);
            set(hXAxisPopupMenuDynamic,'ForegroundColor',foregroundColor,'BackgroundColor',backgroundColor);
            set(hYAxisPopupMenuDynamic,'ForegroundColor',foregroundColor,'BackgroundColor',backgroundColor);
        else
            checkedClassic = 'off';
            checkedDark = 'on';
            ...
            set(hDim3PopupMenu,'ForegroundColor','w','BackgroundColor',[0.4 0.4 0.4]);
            set(hDim4PopupMenu,'ForegroundColor','w','BackgroundColor',[0.4 0.4 0.4]);
            set(hDynamicControllerInput,'ForegroundColor','w','BackgroundColor',[0.4 0.4 0.4]);
            set(hDynamicLatencyInput,'ForegroundColor','w','BackgroundColor',[0.4 0.4 0.4]);
            set(hXAxisPopupMenuDynamic,'ForegroundColor','w','BackgroundColor',[0.4 0.4 0.4]);
            set(hYAxisPopupMenuDynamic,'ForegroundColor','w','BackgroundColor',[0.4 0.4 0.4]);
       end
        ...
        set(hDim3Label,'BackgroundColor',get(hMainFigure,'Color'),'ForegroundColor',foregroundColor);
        set(hDim4Label,'BackgroundColor',get(hMainFigure,'Color'),'ForegroundColor',foregroundColor);
        ...
        set(hDynamicControllerLabel,'BackgroundColor',get(hMainFigure,'Color'),'ForegroundColor',foregroundColor);
        set(hDynamicLatencyLabel,'BackgroundColor',get(hMainFigure,'Color'),'ForegroundColor',foregroundColor);
        set(hXAxisDynamicLabel,'BackgroundColor',get(hMainFigure,'Color'),'ForegroundColor',foregroundColor);
        set(hYAxisDynamicLabel,'BackgroundColor',get(hMainFigure,'Color'),'ForegroundColor',foregroundColor);
        fixAxes2PlotTextColor;
        if isHierarchic
            updatePlotAxes1;
        end
...
% Switches the view to compact mode, which only shows the plotted topology
    function compactView(hObject, eventdata)
        if isDynamic
            set(hToggleDynamicViewButton,'String','Show pareto plot');
            set(hXAxisDynamicLabel,'Visible','off');
            set(hYAxisDynamicLabel,'Visible','off');
            set(hXAxisPopupMenuDynamic,'Visible','off');
            set(hYAxisPopupMenuDynamic,'Visible','off');
...
% pareto-plot
    function fullView(hObject, eventdata)
        if isDynamic
            set(hToggleDynamicViewButton,'String','Hide pareto plot');
            if ~isempty(get(hYAxisPopupMenuDynamic,'String'))
                set(hXAxisDynamicLabel,'Visible','on');
                set(hYAxisDynamicLabel,'Visible','on');
                set(hXAxisPopupMenuDynamic,'Visible','on');
                set(hYAxisPopupMenuDynamic,'Visible','on');
            end
        end
...
%----------------------------------------------------------------------
% Opens an user dialog for limiting the Pareto plot

    function hParetoLimitButtonCallback(hObject,eventdata)
        inputFig = figure('MenuBar','none','Toolbar','none','HandleVisibility','on','Name', 'Set maximum values for the Pareto plot','NumberTitle','off','Position', [(screensize(3)/2 - 225), (screensize(4)/2 - 200), 450, 400],'Resize','on','Color','w');
        hLabelHead = uicontrol('Parent',inputFig,'Units','pixel','HorizontalAlignment','left','Position',[10 345 600 50],...
            'String','Please set your desired maximum values for determining the Pareto-front.','Style','text','BackgroundColor',get(hMainFigure,'Color'),'Visible','on','FontWeight','bold');
        hLabelMaxXaxis = uicontrol('Parent',inputFig,'Units','pixel','HorizontalAlignment','left','Position',[10 310 290 30],...
            'String',char(mValues(get(hXAxisPopupMenu,'Value'),4)),'Style','text','BackgroundColor',get(hMainFigure,'Color'),'Visible','on','FontWeight','bold');
        hEditMaxXaxis = uicontrol('Parent',inputFig,'Units','pixel','HorizontalAlignment','left','Position',[305 320 130 20],...
            'Style','edit','BackgroundColor','w','HandleVisibility','on','Visible','on','String',limits.(char(mValues(get(hXAxisPopupMenu,'Value'),2))));
        hLabelMaxYaxis = uicontrol('Parent',inputFig,'Units','pixel','HorizontalAlignment','left','Position',[10 260 290 30],...
            'String',char(mValues(get(hYAxisPopupMenu,'Value'),4)),'Style','text','BackgroundColor',get(hMainFigure,'Color'),'Visible','on','FontWeight','bold');
        hEditMaxYaxis = uicontrol('Parent',inputFig,'Units','pixel','HorizontalAlignment','left','Position',[305 270 130 20],...
            'Style','edit','BackgroundColor','w','HandleVisibility','on','Visible','on','String',limits.(char(mValues(get(hYAxisPopupMenu,'Value'),2))));
        if (get(hDim3PopupMenu,'Value')~=1)
            hLabelMaxDim3 = uicontrol('Parent',inputFig,'Units','pixel','HorizontalAlignment','left','Position',[10 210 290 30],...
                'String',char(mValuesDim34(get(hDim3PopupMenu,'Value'),4)),'Style','text','BackgroundColor',get(hMainFigure,'Color'),'Visible','on','FontWeight','bold');
            hEditMaxDim3 = uicontrol('Parent',inputFig,'Units','pixel','HorizontalAlignment','left','Position',[305 220 130 20],...
                'Style','edit','BackgroundColor','w','HandleVisibility','on','Visible','on','String',limits.(char(mValuesDim34(get(hDim3PopupMenu,'Value'),2))));
        end
        if (get(hDim4PopupMenu,'Value')~=1)
            hLabelMaxDim4 = uicontrol('Parent',inputFig,'Units','pixel','HorizontalAlignment','left','Position',[10 160 290 30],...
                'String',char(mValuesDim34(get(hDim4PopupMenu,'Value'),4)),'Style','text','BackgroundColor',get(hMainFigure,'Color'),'Visible','on','FontWeight','bold');
            hEditMaxDim4 = uicontrol('Parent',inputFig,'Units','pixel','HorizontalAlignment','left','Position',[305 170 130 20],...
                'Style','edit','BackgroundColor','w','HandleVisibility','on','Visible','on','String',limits.(char(mValuesDim34(get(hDim4PopupMenu,'Value'),2))));
        end
        hResetSave = uicontrol('Parent',inputFig,'Units','pixel','Position',[175 80 100 30],'HandleVisibility','on','Visible','on','String','Reset','Style','pushbutton','HorizontalAlignment','right','Callback',{@resetParetoLimit,inputFig});
        hButtonSave = uicontrol('Parent',inputFig,'Units','pixel','Position',[115 30 100 30],'HandleVisibility','on','Visible','on','String','Ok','Style','pushbutton','HorizontalAlignment','right','Callback',{@paretoLimit,inputFig});
        hButtonCancel = uicontrol('Parent',inputFig,'Units','pixel','Position',[235 30 100 30],'HandleVisibility','on','Visible','on','String','Cancel','Style','pushbutton','HorizontalAlignment','right','Callback',{@closeFig,inputFig});

        function paretoLimit(hObject,eventdata,inputFig)
            limXold=limits.(char(mValues(get(hXAxisPopupMenu,'Value'),2)));
            limYold=limits.(char(mValues(get(hYAxisPopupMenu,'Value'),2)));
            limD3old=[];
            limD4old=[];
            changed=0;
            limits.(char(mValues(get(hXAxisPopupMenu,'Value'),2))) = str2num(get(hEditMaxXaxis,'String'));
            limits.(char(mValues(get(hYAxisPopupMenu,'Value'),2))) = str2num(get(hEditMaxYaxis,'String'));
            if ~strcmp(num2str(limXold),num2str(limits.(char(mValues(get(hXAxisPopupMenu,'Value'),2)))))|| ~strcmp(num2str(limYold),num2str(limits.(char(mValues(get(hYAxisPopupMenu,'Value'),2)))))
                changed=1;
            end
            if (get(hDim3PopupMenu,'Value')~=1)
                limD3old=limits.(char(mValuesDim34(get(hDim3PopupMenu,'Value'),2)));
                limits.(char(mValuesDim34(get(hDim3PopupMenu,'Value'),2))) = str2num(get(hEditMaxDim3,'String'));
                if ~strcmp(num2str(limD3old),num2str(limits.(char(mValuesDim34(get(hDim3PopupMenu,'Value'),2)))))
                    changed=1;
                end
            end
            if (get(hDim4PopupMenu,'Value')~=1)
                limD4old=limits.(char(mValuesDim34(get(hDim4PopupMenu,'Value'),2)));                
                limits.(char(mValuesDim34(get(hDim4PopupMenu,'Value'),2))) = str2num(get(hEditMaxDim4,'String'));
                if ~strcmp(num2str(limD4old),num2str(limits.(char(mValuesDim34(get(hDim4PopupMenu,'Value'),2)))))
                    changed=1;
                end
            end
            close(inputFig);
        ...
        function resetParetoLimit(hObject, eventdata,inputFig)
            limits.maxLatencyN2C=[];
            limits.controllerImbalance=[];
            limits.maxLatencyC2C=[];
            limits.avgLatencyN2C=[];
            ...
            limits.avgLatencyN2CAllControllerFailures=[];
            limits.avgLatencyC2CAllControllerFailures=[];
            set(hEditMaxXaxis,'String','');
            set(hEditMaxYaxis,'String','');
            if (get(hDim3PopupMenu,'Value')~=1)
                set(hEditMaxDim3,'String','');
            end
            if (get(hDim4PopupMenu,'Value')~=1)
                set(hEditMaxDim4,'String','');
            end
            close(inputFig);
            plotAxes2;
        end
...
% and the new Virtual SGWs which are needed
    function calculateMegaEventResources
        ...
        currPlacement = length([solutionAll(1:(k-2)).maxLatencyN2C])+b;
        nk=solution.nk(b,:); 
...
% Plots the pareto plot for hierarchical topologies
    ...
    function plotParetoHierarchical
        ...
        set(gca,'Visible','on');
        hold on;
        plotPareto2D([solutionAll.(valuex)],[solutionAll.(valuey)],'ShowSelectedIdx',currPlacement,'Parent',hPlotAxes2,'ShowMeanValues','off');
...
%----------------------------------------------------------------------
% Loads the dynamic topology
    function [coordinates, topology, citynodes, sgwnodesstatic, neplusnodes, neplusnodesNOSGW, baseX, baseY, corenodes, distanceMatrix,dynamic,isDynamic] = loadDynamic(filename)
        if exist(filename,'file')
            load(filename);
        end
        isDynamic=1;
        if ~exist('dynamic','var') || ~exist('topology','var') || ~exist('coordinates', 'var')
            errordlg('The selected file is not a valid topology.','File Error');
            coordinates=[];
            topology=[];
            citynodes=[];
    ...
    function initDynamic 
        sizeDynTopo(1,1)=min(coordinates(:,1));
        sizeDynTopo(2,1)=max(coordinates(:,1));
        sizeDynTopo(1,2)=min(coordinates(:,2));
        sizeDynTopo(2,2)=max(coordinates(:,2));
        compactView;
        set(hDynamicMenu,'Visible','on');
        for i=1:size(dynamic,1)
            hDynamicMenuitem.(['Subgraph' num2str(i)])  =   uimenu('Parent',hDynamicMenu,'Label',['Plot subgraph ' num2str(i)],'HandleVisibility','on','Callback',{@plotDynamicTopologyCallback,i});
        end
        set(hCheckBoxTM,'Visible','off');
        set(hLabelControllerIDs,'Visible','off');
        set(hEditControllerIDs,'Visible','off');
        ...
        set(hCheckBoxHeatmap,'Visible','off');
        set(hCheckBoxTM,'Visible','off');
        set(hPredefinedViewsMenu,'Visible','off');
        set(hThemesMenu,'Enable','on');
        set(hExtractMenuitem,'Enable','on');
        set(hPrevSubButton,'Visible','on','Enable','off');
        set(hNextSubButton,'Visible','on','Enable','on');
        set(hViewMenu,'Enable','on');
        set(hToggleDynamicViewButton,'Visible','on','Enable','on');
        sgwImg = imread('sgw.png');
        controllerplaces=corenodes(ismember(corenodes,dynamic(1,:)));
        set(hPrevSubButton,'Enable','off');
        set(hBusyLabel,'String','Working...');
        set(hBusyLabel','Visible','off');
        mValues=mValuesDyn;
        set(hXAxisPopupMenuDynamic,'String',mValues(1:3,1));
        set(hYAxisPopupMenuDynamic,'String',mValues(1:3,1));
        set(hXAxisPopupMenuDynamic,'Value',1);
        set(hYAxisPopupMenuDynamic,'Value',2);
        set(hDynamicLatencyInput,'Visible','on');
        set(hDynamicLatencyLabel,'Visible','on');
        set(hDynamicLatencyInput,'String','1380');
        calculateDynamicControllerPlacement;
        plotDynamicTopology(1);
    end

    function plotDynamicTopologyCallback(hObject, eventdata, currentSubgraph)
        if ~currentSubgraph
            currSubgraph=currSubgraph+1;
        elseif currentSubgraph == -1
            currSubgraph=currSubgraph-1;
        else
            currSubgraph=currentSubgraph;
        end
        if currSubgraph==1
            set(hPrevSubButton,'Enable','off');
            set(hNextSubButton,'Enable','on');
        elseif currSubgraph<size(dynamic,1)
            set(hPrevSubButton,'Enable','on');
            set(hNextSubButton,'Enable','on');
        else
            set(hPrevSubButton,'Enable','on');
            set(hNextSubButton,'Enable','off');
        end
        prevButt=get(hPrevSubButton,'Enable');
        nextButt=get(hNextSubButton,'Enable');
       	set(hPrevSubButton,'Enable','off');
        set(hNextSubButton,'Enable','off');
        set(hBusyLabel,'Visible','on');
        set(hDynamicLatencyInput,'Enable','off');
        uiwait(hMainFigure,1);
        calculateDynamicControllerPlacement;
        plotDynamicTopology(currSubgraph);
        set(hPrevSubButton,'Enable',prevButt);
        set(hNextSubButton,'Enable',nextButt);
        set(hBusyLabel,'Visible','off');
        set(hDynamicLatencyInput,'Enable','on');
    end

    function plotDynamicTopology(currentSubgraph)
        currSubgraph=currentSubgraph;
        axes(hPlotAxes1);
        cla
        box off;
        ...
        %plot links
        if strcmp(get(hThemesClassicMenuitem,'Checked'),'on')
            gplot(topology(dynamic(currentSubgraph,dynamic(currentSubgraph,:)~=inf),dynamic(currentSubgraph,dynamic(currentSubgraph,:)~=inf))~=inf,coordinates(dynamic(currentSubgraph,dynamic(currentSubgraph,:)~=inf),:),'k-');
        else
            gplot(topology(dynamic(currentSubgraph,dynamic(currentSubgraph,:)~=inf),dynamic(currentSubgraph,dynamic(currentSubgraph,:)~=inf))~=inf,coordinates(dynamic(currentSubgraph,dynamic(currentSubgraph,:)~=inf),:),'w-');
        end 
        mycolorsstatic=[0.6 0.6 0.6];
        mycolors=hsv(length(controllerplaces));
        currNodes=citynodes(ismember(citynodes,dynamic(currSubgraph,dynamic(currSubgraph,:)~=inf)));
        [mindiff, assignmentIdx]=min(distanceMatrix(currNodes,controllerplaces),[],2);

        %plot nodes
        for i=1:length(controllerplaces)
            plot(coordinates(currNodes(find(assignmentIdx==i))',1),coordinates(currNodes(find(assignmentIdx==i))',2),'d','Color',darken(mycolors(i,:)),'MarkerSize',8,'MarkerFaceColor',mycolors(i,:),'LineSmoothing','off','Parent',hPlotAxes1)
        end
        
        % plot sgw locations
        sgwlocations = corenodes(ismember(corenodes,dynamic(currentSubgraph,dynamic(currentSubgraph,:)~=inf)));
        plot(coordinates(sgwlocations,1),coordinates(sgwlocations,2),'o','Color',darken(mycolorsstatic),'MarkerFaceColor','w','MarkerSize',14,'LineSmoothing','off','Parent',hPlotAxes1);

        % plot sgws
        
        [imgH, imgW, tildevar] = size(sgwImg);
        for i=1:length(controllerplaces)
            image([(coordinates(controllerplaces(i),1)-(imgW*10)/2 +500) (coordinates(controllerplaces(i),1)+(imgW*10)/2 -500)],[coordinates(controllerplaces(i),2)+(imgH*10)/2 coordinates(controllerplaces(i),2)-(imgH*10)/2],sgwImg,'Parent',gca);
            plot(coordinates(controllerplaces(i),1),coordinates(controllerplaces(i),2),'ko','MarkerFaceColor',mycolors(i,:),'MarkerSize',12,'LineSmoothing','off','Parent',hPlotAxes1)
            
        end
        set(gca,'Visible','off');
        xlim([sizeDynTopo(1,1)*1.7 sizeDynTopo(2,1)*1.005]);
        ylim([sizeDynTopo(1,2)*1.7 sizeDynTopo(2,2)*1.007]);
    end

    function toggleDynamicViewCallback(hObject,eventdata)
        if (strcmp(get(hFullViewMenuitem,'Checked'),'on'))
            compactView;
        else
            fullView;
        end           
    ...
    function fixDynamicLinkTheme
        plotDynamicTopology(currSubgraph);
    end

    function calculateDynamicControllerPlacement
        panelAxis1Pos = get(hPanelAxes1,'Position');
        if panelAxis1Pos(4) < 0.8
            set(hXAxisDynamicLabel,'Visible','on');
            set(hYAxisDynamicLabel,'Visible','on');
        ...
        valuex=char(mValues{get(hXAxisPopupMenuDynamic,'Value'),2});
        valuey=char(mValues{get(hYAxisPopupMenuDynamic,'Value'),2});
        currNodes=citynodes(ismember(citynodes,dynamic(currSubgraph,dynamic(currSubgraph,:)~=inf)));
        sgwlocations = corenodes(ismember(corenodes,dynamic(currSubgraph,dynamic(currSubgraph,:)~=inf)));
        [mindiff, assignmentIdx]=calculateBaseStationAssignmentTransport(distanceMatrix,currNodes,sgwlocations);
        mycolors=repmat(hsv(10),ceil(length(citynodes)/10),1);
        if matlabVersion < 2013
            dist=distanceMatrix(currNodes,sgwlocations);
        else
            dist=distanceMatrix(currNodes,sgwlocations);
        end
        a=1;
        ...
        while a*nanmax(nanmax(distanceMatrix)) > ceil(str2double(get(hDynamicLatencyInput,'String'))) && ~isempty(solutionTmp)
            k=k+1;
            if k > length(sgwlocations)
                k=k-1;
                uiwait(warndlg('The desired maximum Node to PGW distance can not be achieved with this amount of PGW-locations.','Warning'));
            	break;
            end
            solutionTmp=evaluateSingleInstanceDynamic(dist,k,nanmax(nanmax(distanceMatrix)));
            if isfield(solutionTmp,'maxLatencyN2C') && ~isempty(solutionTmp.maxLatencyN2C)
                solution=solutionTmp;
                [a,b]=min(solution.maxLatencyN2C);
            else
                break;
        ...
        nk=combnk(sgwlocations,k);
        val1=min(solution.(mValues{get(hXAxisPopupMenuDynamic,'Value'),2}));
        val2=min(solution.(mValues{get(hYAxisPopupMenuDynamic,'Value'),2})(solution.(mValues{get(hXAxisPopupMenuDynamic,'Value'),2})==val1));
        idx=find(solution.(mValues{get(hXAxisPopupMenuDynamic,'Value'),2})==val1 & solution.(mValues{get(hYAxisPopupMenuDynamic,'Value'),2})==val2,1,'last');
        currPlacement = idx;
        controllerplaces=nk(idx,:);
        plotParetoDynamic;
    end

    function plotParetoDynamic
        axes(hPlotAxes2);
        cla;
        set(gca,'Visible','on');
        hold on;
        plotPareto2D([solution.(valuex)],[solution.(valuey)],'ShowSelectedIdx',currPlacement,'Parent',hPlotAxes2,'ShowMeanValues','off');
        xlabel(char(mValues(get(hXAxisPopupMenuDynamic,'Value'),3)));
        ylabel(char(mValues(get(hYAxisPopupMenuDynamic,'Value'),3)));
    end

    function hAxisPopupMenuDynamicCallback(hObject, eventdata)
        valuex=char(mValues{get(hXAxisPopupMenuDynamic,'Value'),2});
        valuey=char(mValues{get(hYAxisPopupMenuDynamic,'Value'),2});
        plotParetoDynamic;
    end

    function plotFiguresDynamicCallback(hObject,eventdata)
        plotFiguresDynamic;
    end

    function plotFiguresDynamic
        plotDynamicTopology(currSubgraph);
        plotParetoDynamic;
    end

    function dynamicInputCallback(hObject, eventdata)
        dynamicInput
    end
...
%----------------------------------------------------------------------
% HEURISTICAL PLACEMENT
%----------------------------------------------------------------------
% Checks if all required files for the Pareto Capacitated kMedoids
% evaluation are available.
% If not, the user is asked to download them.
% Otherwise, the user is asked for the desired parameters

    function initPCKMCallback(hObject,eventdata)
        lapjvExists=1;
        kMedExists=1;
        infoDia=0;
        if ~exist('code/heuristics/lapjv.m') 
            lapjvExists=0;
            infoDia=1;
        end
        if ~exist('code/heuristics/kmedioids.m')
            kMedExists=0;
            infoDia=1;
        end
        if infoDia
            pocoFolder=strcat(pwd,'\code\heuristics\');
            qString ={'In order to execute Pareto Capacitated k-Medoids, the following files are required.','Please download the particular files from Matlab FileExchange via the given hyperlinks and save them to:',pocoFolder,'','','','','','',''};           
            if ~lapjvExists
                qString{5}='- Jonker-Volgenant Algorithm for Linear Assignment Problem V3.0 by Yi Cao';
                qString{6}='http://www.mathworks.com/matlabcentral/fileexchange/26836-lapjv-jonker-volgenant-algorithm-for-linear-assignment-problem-v3-0';
            end
            if ~kMedExists
                if ~isempty(qString{5})
                    qString{8}='- kMedoids Clustering by Benjamin Sapp';
                    qString{9}='http://www.mathworks.com/matlabcentral/fileexchange/28860-kmedioids';
                else
                    qString{5}='- kMedoids Clustering by Benjamin Sapp';
                    qString{6}='http://www.mathworks.com/matlabcentral/fileexchange/28860-kmedioids';
                end
            end
            hquest=questdlg(qString,'Missing file(s)!','Visit Matlab FileExchange', 'Cancel','Visit Matlab FileExchange');
            if strcmp(hquest,'Visit Matlab FileExchange')
                if ~lapjvExists
                    web http://www.mathworks.com/matlabcentral/fileexchange/26836-lapjv-jonker-volgenant-algorithm-for-linear-assignment-problem-v3-0 -browser;
                end
                if ~kMedExists
                    web http://www.mathworks.com/matlabcentral/fileexchange/28860-kmedioids -browser;
                end
            end               
        else
            getPCKMParametersInput;
        end
    end

%----------------------------------------------------------------------
% Opens a dialog where the user is asked to type in the desired parameter
% values for the Pareto Capacitated kMedoids evaluation.

    function getPCKMParametersInput
        inputFig = figure('MenuBar','none','Toolbar','none','HandleVisibility','on','Name', 'Set parameters for Pareto Capacitated k-Medoids','NumberTitle','off','Position', [(screensize(3)/2 - 225), (screensize(4)/2 - 200), 450, 400],'Resize','on','Color','w');
        hLabelHead = uicontrol('Parent',inputFig,'Units','pixel','HorizontalAlignment','left','Position',[10 345 600 50],...
            'String','Please set your desired parameters for Pareto Capacitated k-Medoids.','Style','text','BackgroundColor',get(hMainFigure,'Color'),'Visible','on','FontWeight','bold');
        %   rhoRange:     starting temperature (~50)
        hLabelRhoRange = uicontrol('Parent',inputFig,'Units','pixel','HorizontalAlignment','left','Position',[10 310 290 30],...
            'String','Range of rho in order to get a bigger Pareto-front of evaluations','Style','text','BackgroundColor',get(hMainFigure,'Color'),'Visible','on','FontWeight','bold');
        hEditRhoRange = uicontrol('Parent',inputFig,'Units','pixel','HorizontalAlignment','left','Position',[305 320 130 20],...
            'Style','edit','BackgroundColor','w','HandleVisibility','on','Visible','on','String','0:1:9');
        %   nReps:    number of repetitions
        hLabelNReps = uicontrol('Parent',inputFig,'Units','pixel','HorizontalAlignment','left','Position',[10 270 290 30],...
            'String','Number of repetitions of each evaluation','Style','text','BackgroundColor',get(hMainFigure,'Color'),'Visible','on','FontWeight','bold');
        hEditNReps = uicontrol('Parent',inputFig,'Units','pixel','HorizontalAlignment','left','Position',[305 280 130 20],...
            'Style','edit','BackgroundColor','w','HandleVisibility','on','Visible','on','String','10');
        %   k:      number of controllers per placement
        hLabelKController = uicontrol('Parent',inputFig,'Units','pixel','HorizontalAlignment','left','Position',[10 230 290 30],...
            'String','Number of controllers per placement','Style','text','BackgroundColor',get(hMainFigure,'Color'),'Visible','on','FontWeight','bold');
        hEditKController = uicontrol('Parent',inputFig,'Units','pixel','HorizontalAlignment','left','Position',[305 240 130 20],...
            'Style','edit','BackgroundColor','w','HandleVisibility','on','Visible','on','String','');
        %   seed:   seed for the RNG
        hLabelSeed = uicontrol('Parent',inputFig,'Units','pixel','HorizontalAlignment','left','Position',[10 190 290 30],...
            'String','Seed for random number generator','Style','text','BackgroundColor',get(hMainFigure,'Color'),'Visible','on','FontWeight','bold');
        hEditSeed = uicontrol('Parent',inputFig,'Units','pixel','HorizontalAlignment','left','Position',[305 200 130 20],...
            'Style','edit','BackgroundColor','w','HandleVisibility','on','Visible','on','String','42');
        hLabelParetoCheck = uicontrol('Parent',inputFig,'Units','pixel','HorizontalAlignment','left','Position',[10 150 290 30],...
            'String','Show only Pareto-optimal placements','Style','text','BackgroundColor',get(hMainFigure,'Color'),'Visible','off','FontWeight','bold');
        hEditParetoCheck = uicontrol('Parent',inputFig,'Units','pixel','HorizontalAlignment','left','Position',[305 165 130 20],...
            'Style','checkbox','BackgroundColor','w','HandleVisibility','on','Visible','off');        
        if exist('code/heuristics/paretofront.m') && exist('code/heuristics/paretoGroup.m') 
            set(hLabelParetoCheck,'Visible','on');
            set(hEditParetoCheck,'Visible','on');
        end
        handles = [hEditRhoRange,hEditNReps,hEditKController,hEditSeed,hEditParetoCheck];
        hButtonStart = uicontrol('Parent',inputFig,'Units','pixel','Position',[115 30 100 30],'HandleVisibility','on','Visible','on','String','Start','Style','pushbutton','HorizontalAlignment','right','Callback',{@startPCKMCallback,inputFig,handles});
        hButtonCancel = uicontrol('Parent',inputFig,'Units','pixel','Position',[235 30 100 30],'HandleVisibility','on','Visible','on','String','Cancel','Style','pushbutton','HorizontalAlignment','right','Callback',{@closeFig,inputFig});
    end

%----------------------------------------------------------------------
% Gets the parameter values choosen by the user and starts the Pareto
% Capacitated kMedoid evaluation using these values.
 
    function startPCKMCallback(hObject, eventdata, inputFig, handles)
        if length(str2num(get(handles(1),'String'))) > 0 & length(str2num(get(handles(2),'String')))==1 & length(str2num(get(handles(3),'String')))==1 & length(str2num(get(handles(4),'String')))==1 
            if ~strcmp(get(handles(1),'String'),'i') & ~strcmp(get(handles(1),'String'),'j') & ~strcmp(get(handles(2),'String'),'i') & ~strcmp(get(handles(2),'String'),'j') & ~strcmp(get(handles(3),'String'),'i') & ~strcmp(get(handles(3),'String'),'j') & ~strcmp(get(handles(4),'String'),'i') & ~strcmp(get(handles(4),'String'),'j')
                isPCKM=1;
                rhoRange = str2num(get(handles(1),'String'));
                nReps = str2num(get(handles(2),'String'));
                kController = str2num(get(handles(3),'String'));
                seed = str2num(get(handles(4),'String'));
                paretoCheck = get(handles(5),'Value');
                close(inputFig);
                [centers, assignments] = capkm(distanceMatrix, kController, rhoRange, nReps, seed);
                nk=centers';
                [avgLatencyN2C,maxLatencyN2C,controllerlessNodes,controllerImbalance,avgLatencyC2C,maxLatencyC2C]=calculateMetricsForAssignment(distanceMatrix,nk,assignments,ones(1,length(distanceMatrix)));
                solution.avgLatencyN2C=avgLatencyN2C;
                solution.maxLatencyN2C=maxLatencyN2C;
                solution.controllerlessNodes=controllerlessNodes;
                solution.controllerImbalance=controllerImbalance;
                solution.avgLatencyC2C=avgLatencyC2C;
                solution.maxLatencyC2C=maxLatencyC2C;
                if paretoCheck
                     front=find(paretoGroup([avgLatencyN2C' maxLatencyN2C' controllerImbalance' avgLatencyC2C' maxLatencyC2C']));
                     nk=centers(:,front)';
                     assignments=assignments(:,front);
                     solution.avgLatencyN2C=avgLatencyN2C(front);
                     solution.maxLatencyN2C=maxLatencyN2C(front);
                     solution.controllerlessNodes=controllerlessNodes(front);
                     solution.controllerImbalance=controllerImbalance(front);
                     solution.avgLatencyC2C=avgLatencyC2C(front);
                     solution.maxLatencyC2C=maxLatencyC2C(front);
                end
                plotHeuristicEval(nk,kController);
            end
        end
    end

%----------------------------------------------------------------------
% Checks if all required files for the Pareto Simulated Annealing
% evaluation are available.
% If not, the user is asked to download them.
% Otherwise, the user is asked for the desired parameters

    function initPSACallback(hObject,eventdata)
        isPCKM=0;
        infoDia=0;
        if ~exist('code/heuristics/paretofront.m') & ~exist('code/heuristics/paretoGroup.m') 
            infoDia=1;
        ...
        if infoDia
            pocoFolder=strcat(pwd,'\code\heuristics\');
            qString ={'In order to execute Pareto Simulated Annealing, the following file is required.','Please download the particular files from Matlab FileExchange via the given hyperlinks and save them to:',pocoFolder,'','Pareto Front by Yi Cao','http://www.mathworks.com/matlabcentral/fileexchange/17251-pareto-front',''};           
            hquest=questdlg(qString,'Missing file(s)!','Visit Matlab FileExchange', 'Cancel','Visit Matlab FileExchange');
            if strcmp(hquest,'Visit Matlab FileExchange')
                web http://www.mathworks.com/matlabcentral/fileexchange/17251-pareto-front -browser;
            end
        else
            getPSAParameterInput;
        end
    end

%----------------------------------------------------------------------
% Opens a dialog where the user is asked to type in the desired parameter
% values for the Pareto Simulated Annealing evaluation.

    function getPSAParameterInput
        inputFig = figure('MenuBar','none','Toolbar','none','HandleVisibility','on','Name', 'Set parameters for Pareto Simulated Annealing','NumberTitle','off','Position', [(screensize(3)/2 - 225), (screensize(4)/2 - 200), 450, 400],'Resize','on','Color','w');
        hLabelHead = uicontrol('Parent',inputFig,'Units','pixel','HorizontalAlignment','left','Position',[10 345 600 50],...
            'String','Please set your desired parameters for the Pareto Simulated Annealing.','Style','text','BackgroundColor',get(hMainFigure,'Color'),'Visible','on','FontWeight','bold');
        %   T0:     starting temperature (~50)
        hLabelTemperature = uicontrol('Parent',inputFig,'Units','pixel','HorizontalAlignment','left','Position',[10 310 290 30],...
            'String','Starting temperature','Style','text','BackgroundColor',get(hMainFigure,'Color'),'Visible','on','FontWeight','bold');
        hEditTemperature = uicontrol('Parent',inputFig,'Units','pixel','HorizontalAlignment','left','Position',[305 320 130 20],...
            'Style','edit','BackgroundColor','w','HandleVisibility','on','Visible','on','String','50');
        %   rho:    cooling rate (~.9)
        hLabelCooling = uicontrol('Parent',inputFig,'Units','pixel','HorizontalAlignment','left','Position',[10 270 290 30],...
            'String','Cooling rate (< 1.0)','Style','text','BackgroundColor',get(hMainFigure,'Color'),'Visible','on','FontWeight','bold');
        hEditCooling = uicontrol('Parent',inputFig,'Units','pixel','HorizontalAlignment','left','Position',[305 280 130 20],...
            'Style','edit','BackgroundColor','w','HandleVisibility','on','Visible','on','String','0.9');
        %   m:      number of iterations per temperature level
        hLabelIterations = uicontrol('Parent',inputFig,'Units','pixel','HorizontalAlignment','left','Position',[10 230 290 30],...
            'String','Number of iterations per temperature level','Style','text','BackgroundColor',get(hMainFigure,'Color'),'Visible','on','FontWeight','bold');
        hEditIterations = uicontrol('Parent',inputFig,'Units','pixel','HorizontalAlignment','left','Position',[305 240 130 20],...
            'Style','edit','BackgroundColor','w','HandleVisibility','on','Visible','on','String','10');
        %   s:      number of elements in the set of generating solutions S
        hLabelElements = uicontrol('Parent',inputFig,'Units','pixel','HorizontalAlignment','left','Position',[10 190 290 30],...
            'String','Number of elements in the set of generating solutions','Style','text','BackgroundColor',get(hMainFigure,'Color'),'Visible','on','FontWeight','bold');
        hEditElements = uicontrol('Parent',inputFig,'Units','pixel','HorizontalAlignment','left','Position',[305 200 130 20],...
            'Style','edit','BackgroundColor','w','HandleVisibility','on','Visible','on','String','10');
        %   k:      number of controllers per placement
        hLabelKController = uicontrol('Parent',inputFig,'Units','pixel','HorizontalAlignment','left','Position',[10 150 290 30],...
            'String','Number of controllers per placement','Style','text','BackgroundColor',get(hMainFigure,'Color'),'Visible','on','FontWeight','bold');
        hEditKController = uicontrol('Parent',inputFig,'Units','pixel','HorizontalAlignment','left','Position',[305 160 130 20],...
            'Style','edit','BackgroundColor','w','HandleVisibility','on','Visible','on','String','');
        %   seed:   seed for the RNG
        hLabelSeed = uicontrol('Parent',inputFig,'Units','pixel','HorizontalAlignment','left','Position',[10 110 290 30],...
            'String','Seed for random number generator','Style','text','BackgroundColor',get(hMainFigure,'Color'),'Visible','on','FontWeight','bold');
        hEditSeed = uicontrol('Parent',inputFig,'Units','pixel','HorizontalAlignment','left','Position',[305 120 130 20],...
            'Style','edit','BackgroundColor','w','HandleVisibility','on','Visible','on','String','42');
        handles = [hEditTemperature,hEditCooling,hEditIterations,hEditElements,hEditKController,hEditSeed];
        hButtonStart = uicontrol('Parent',inputFig,'Units','pixel','Position',[115 30 100 30],'HandleVisibility','on','Visible','on','String','Start','Style','pushbutton','HorizontalAlignment','right','Callback',{@startPSACallback,inputFig,handles});
        hButtonCancel = uicontrol('Parent',inputFig,'Units','pixel','Position',[235 30 100 30],'HandleVisibility','on','Visible','on','String','Cancel','Style','pushbutton','HorizontalAlignment','right','Callback',{@closeFig,inputFig});
    end

%----------------------------------------------------------------------
% Gets the parameter values choosen by the user and starts the Pareto
% Simulated Annealing evaluation using these values.

    function startPSACallback(hObject,eventdata,inputFig,handles)
        if length(str2num(get(handles(1),'String'))) == 1 & ~isnan(str2double(get(handles(2),'String')))==1 & length(str2num(get(handles(3),'String')))==1 & length(str2num(get(handles(4),'String')))==1 & length(str2num(get(handles(5),'String')))==1 & length(str2num(get(handles(6),'String')))==1
            if ~strcmp(get(handles(1),'String'),'i') & ~strcmp(get(handles(1),'String'),'j') & ~strcmp(get(handles(2),'String'),'i') & ~strcmp(get(handles(2),'String'),'j') & ~strcmp(get(handles(3),'String'),'i') & ~strcmp(get(handles(3),'String'),'j') & ~strcmp(get(handles(4),'String'),'i') & ~strcmp(get(handles(4),'String'),'j') & ~strcmp(get(handles(5),'String'),'i') & ~strcmp(get(handles(5),'String'),'j') & ~strcmp(get(handles(6),'String'),'i') & ~strcmp(get(handles(6),'String'),'j')
                t0 = str2num(get(handles(1),'String'));
                cooling = str2double(get(handles(2),'String'));
                iter = str2num(get(handles(3),'String'));
                elements = str2num(get(handles(4),'String'));
                kController = str2num(get(handles(5),'String'));
                seed = str2num(get(handles(6),'String'));
                if cooling < 1.0
                    close(inputFig);
                    [paretoOptima,solution]=psa(t0, cooling, iter, elements, distanceMatrix, kController, seed);
                    plotHeuristicEval(paretoOptima,kController);
                end
            end
        end
    end
    ...
    function plotHeuristicEval(placements,k)
    	set(hScenarioLabel,'Visible','off');
        set(hScenarioPopupMenu,'Visible','off');
        set(hMainFigure,'Pointer','watch');
        set(hStatusLabel,'String','Calculating placements - please wait...');
        ...
        val1=min(solution.maxLatencyN2C);
        val2=min(solution.controllerImbalance(solution.maxLatencyN2C==val1));
        idx=find(solution.maxLatencyN2C==val1 & solution.controllerImbalance==val2,1,'first');
        currPlacement = idx
        set(hResultPopupMenu,'Value',2);
        set(hEditControllerIDs,'String',num2str(nk(idx,:)));   
        set(hEditNodeFailureIDs,'String','');
